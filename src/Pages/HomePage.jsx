...
// import tech_web_back from "../../assets/images/HomePage/TECH-WEB.svg";
    ...
    <>
      <div className="container">
        ...
        <div className="d2-link-container">
          <div className="text">
            <h1>Curious About How <span style={{color:'#2c85eb'}}> Pay and Parcel </span> Works?</h1>
            <p>
              Discover everything you need to know, from getting started to
              making the most of our advanced features. <br></br> Whether you're a
              developer integrating APIs or a business streamlining logistics,
              we've got you covered. <br></br>Hit the button below to explore and take
              your delivery process to the next level!
            </p>
